...
![Graph of k-fold cross validation accuracy of weight dimension values]({{ "/assets/dota2-k-fold-cross-validation.png" | absolute_url }})
...
![Plot of learning curve for KNN]({{ "/assets/dota2-knn.png" | absolute_url }})
